...
void PWM_init()
{
	...
	/* Set match value for PWM match channel 0 = 20000us .This sets the Time Period of the pulse. */
	...
	*  PWM Pulse Width is set by the PWMMRO */
	...
	/*config for PWM match channel 2. the ratio of match values of timer0 and timer2 is the duty cycle. */
